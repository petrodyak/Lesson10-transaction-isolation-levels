...
host = "localhost"
user = "root"
password = "UserPsw12345"
database = "mydb"

table_name = 'users'

# Function to create table
def recreate_table_mysql(table_name):
    try:
...
def insert_users_in_parallel_mysql():
    num_users =1000  # Change this number to adjust the number of users to insert
    num_threads = 1 # Change this number of threads
    print('num_users: ' , num_users)
    print('num_threads: ' , num_threads)

    try:
        recreate_table_mysql(table_name)
...
if __name__ == "__main__":
    ...
    insert_users_in_parallel_mysql()
